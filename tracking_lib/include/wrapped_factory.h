...
template <class T> class abstract_wrapped_factory
{
private:
...
public:
  filter_wrapped_factory()
  {
    ...
    add(std::make_shared< factory_creator<abstract_filter_factory, alpha_beta_gamma_filter_factory> >("alpha_beta_gamma"));
    add(std::make_shared< factory_creator<abstract_filter_factory, static_kalman_filter_factory> >("static_kalman"));
    add(std::make_shared< factory_creator<abstract_filter_factory, dynamic_kalman_filter_factory > >("dynamic_kalman"));
  }
};
...
public:
  ...
  {  
		add(std::make_shared< factory_creator<abstract_extrapolator_factory, last_point_extrapolator_factory> >("last_point_extrapolator"));
		add(std::make_shared< factory_creator<abstract_extrapolator_factory, linear_extrapolator_factory> >("linear_extrapolator"));
	}
};
...
public:
  ...
  {  
		add(std::make_shared< factory_creator<abstract_initializer_factory, initializer_by_points_factory> >("by_points"));
	}
};
