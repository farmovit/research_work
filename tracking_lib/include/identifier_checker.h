...
{
public:
  bool check(const tracking_object &object, 
...
protected:
  ...
  virtual bool check_self(const tracking_object &object, 
													const measurement_data &data) = 0;
  
  bool check_next(const tracking_object &object, 
									const measurement_data &data)
  {
...
private:
  bool check_self(const tracking_object &object, 
									const measurement_data &data);
