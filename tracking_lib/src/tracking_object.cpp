...
void tracking_object::extrapolate(const measurement_data& measurement) {
	filter_params extrapolated_data = m_extrapolator->extrapolate(measurement.time);
...
void tracking_object::set_number(const std::size_t& a_number) {
  m_params.internal_idx = a_number;
}

void tracking_object::set_out_number(const std::size_t& a_numb) {
...
std::size_t tracking_object::get_number() const {
	return m_params.internal_idx;
}

std::size_t tracking_object::get_out_number() const {
