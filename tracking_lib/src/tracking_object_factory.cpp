...
void tracking_object_factory::set_extrapolator_factory(
        std::shared_ptr<abstract_extrapolator_factory> a_extrapolator_factory) {
    m_extrapolator_factory = a_extrapolator_factory;
}

void
tracking_object_factory::set_initializer_factory(std::shared_ptr<abstract_initializer_factory> a_initializer_factory) {
